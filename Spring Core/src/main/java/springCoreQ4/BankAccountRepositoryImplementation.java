...
public class BankAccountRepositoryImplementation implements BankAccountRepository{

    private BankAccount bankAccount1;
    private BankAccount bankAccount2;

    public BankAccountRepositoryImplementation() {
    }

    public BankAccountRepositoryImplementation(BankAccount bankAccount1, BankAccount bankAccount2) {
